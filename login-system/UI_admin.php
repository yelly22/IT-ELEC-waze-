...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="UI_admin.php" class="active"><span class="las la-igloo"> Dashboard </span></a>
                </li>
                <li>
                    <a href="AD_profile.php"> <span class="las la-users"> Profile </span></a>
                </li>
                <li>
