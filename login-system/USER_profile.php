            ...
            <div class="single-pf">
                <div>
                    <div class="pf">
                        ...
                        <label class="form-label"> <?php echo $_SESSION['user_name']; ?> </label><br>
                        <small> User </small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card mb-3 content">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-secondary">
                                <input type="text" value="<?php echo $_SESSION['user_age']; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-secondary">
                                <input type="text" value="<?php echo $_SESSION['user_phone']; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-secondary">
                                <input type="text" value="<?php echo $_SESSION['user_address']; ?>" readonly>
                                </div> <br>
                            </div>

                            <a href="USER_editpf.php" class="editpfp">
                                <img src="edit.png">
                                <p> Edit profile </p>
                            </a>
